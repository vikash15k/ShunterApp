...
export class SignalRService {
  ...
  private getSignalRConnection(): Observable<SignalRConnection> {
   //let str = '${environment.signalRurl}SignalRConnection';
    return this.http.get<SignalRConnection>('https://functionapp-rangerapp-dev.azurewebsites.net/api/SignalRConnection');
   // return this.http.get<SignalRConnection>('${environment.signalRurl}SignalRConnection');
  }
